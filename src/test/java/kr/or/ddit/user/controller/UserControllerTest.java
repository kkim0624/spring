...
//		assertEquals(10, pageVo.getPageSize());
	...
	public void userTest() throws Exception {
		...
		/***When***/
		MvcResult mvcResult = mockMvc.perform(get("/user").param("userId", "brown")).andReturn();
		ModelAndView mav = mvcResult.getModelAndView();
		String viewName = mav.getViewName();
	...
	public void userModifyGetTest() throws Exception {
		...
		/***When***/
		MvcResult mvcResult = mockMvc.perform(get("/userModify").param("userId", "brown")).andReturn();
		ModelAndView mav = mvcResult.getModelAndView();
		String viewName = mav.getViewName();
		UserVo userVo = (UserVo)mav.getModelMap().get("userVo");
