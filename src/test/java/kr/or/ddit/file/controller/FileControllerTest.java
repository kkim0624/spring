...
public class FileControllerTest extends ControllerTestEnv{
	...
	* Method 설명 : 파일 업로드 테스트
	...
	public void uploadTest() throws IOException, Exception {
		...
		/***Given***/
//		File file = new File("C:\\Users\\PC04\\Desktop\\레인저스사진\\sally.png");
		
		File file = new File("src/test/resources/kr/or/ddit/testenv/sally.png"); // 민창
//		File file = new File(getClass().getClassLoader().getResource("kr/or/ddit/testenv/sally.png").getFile()); // 환석
